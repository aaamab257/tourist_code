...
class Home extends StatefulWidget {
  final List<LandmarksModel> landmarks;
  const Home({super.key, required this.landmarks});
        ...
        InkWell(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) =>
                    EventDetail(name: name, dis: dis, location: location)));
          },
          child: Container(
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context,
                                    ...
                                    tripCardTile(
                                        image: image2,
                                        name: widget.landmarks[index].name!,
                                        location:
                                            widget.landmarks[index].location!,
                                        dis: widget
